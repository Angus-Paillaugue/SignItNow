...
<div class="relative isolate px-6 flex flex-col justify-center items-center lg:px-8 h-screen">
	  ...
	  <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
		...
		<div class="text-center">
			<h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-8xl">SignItNow</h1>
			...
			<div class="mt-10 flex items-center justify-center gap-x-6">
				<a href="/sign-in" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</a>
